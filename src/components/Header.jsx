  ...
  return (
    <div className=" flex justify-between items-center p-5 shadow-md shadow-gray-300 ">
      ...
      {isLogged ? (
        <button
          type="button"
          className="inline-block px-6 py-2.5 bg-black text-white font-medium
          text-xs leading-tight rounded shadow-md 
        ...
        <button
          type="button"
          className="inline-block px-6 py-2.5 dark:bg-gray-800 text-white font-medium
          text-xs leading-tight rounded shadow-md hover:bg-black
          hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none
          focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
          onClick={handleLogin}
        >
